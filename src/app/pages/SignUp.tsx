...
export function SignUp() {
  ...
  const inputStyle: React.CSSProperties = {
    ...
    background:'rgba(255,255,255,0.07)', border:'1px solid rgba(100,180,255,0.25)',
    borderRadius:'12px', color:'#e0f0ff', fontSize:'15px',
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        borderRadius:'24px', padding:'44px', width:'100%', maxWidth:'460px',
        ...
        <form onSubmit={handleSignUp}>
          ...
          <div style={{ textAlign:'center' }}>
            <p style={{ color:'rgba(180,210,255,0.7)', fontSize:'14px', margin:0 }}>
              ...
              <Link to="/" style={{ color:'#38bdf8', fontWeight:600, textDecoration:'none' }}>Login</Link>
            </p>
          </div>
        </form>
      </div>
