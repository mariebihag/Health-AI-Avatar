...
export function UserProfileProvider({ children }: { children: ReactNode }) {
  ...
  const computeBMI = () => {
    ...
    addNotification(`BMI recorded: ${bmi} — Recommended daily intake: ${recommendedCalories} kcal (${goalLabel})`);
  };

  return (
    <UserProfileContext.Provider value={{ profile, updateProfile, computeBMI, notifications, addNotification, clearNotification }}>
      {children}
